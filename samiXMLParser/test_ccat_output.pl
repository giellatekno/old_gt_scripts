...
# 'table.xml',
    ...
    'p-errorortreal-with-multiword-error.xml' => {
        ...
        "-typos -ort" => "",
        "-typos -ort -C" => "",
        "-typos -ortreal" => "fiske leting\tfiskeleting\t#errtype=nosplit,pos=noun, file: p-errorortreal-with-multiword-error.xml\n",
        "-typos -morphsyn" => "",
        "-typos -syn" => "",
        "-typos -lex" => "",
        "-S" => "fiske leting\tfiskeleting\t#errtype=nosplit,pos=noun, file: p-errorortreal-with-multiword-error.xml\n",
        "-f -S" => "fiske leting\tfiskeleting\t#errtype=nosplit,pos=noun, file: p-errorortreal-with-multiword-error.xml\n",
        "-S -C" => "fiske\nleting\n",
        "-S -ort" => "fiske\nleting\n",
        "-S -ort -C" => "fiske\nleting\n",
        "-S -ortreal" => "fiske leting\tfiskeleting\t#errtype=nosplit,pos=noun, file: p-errorortreal-with-multiword-error.xml\n",
        "-S -morphsyn" => "fiske\nleting\n",
        "-S -syn" => "fiske\nleting\n",
        "-S -lex" => "fiske\nleting\n",
        "-a -S" => "fiske leting\tfiskeleting\t#errtype=nosplit,pos=noun, file: p-errorortreal-with-multiword-error.xml\n",
    },
...
#         "-typos" => "skoledagene er så vanskerlig\tskoledagene er så vanskelige\t#cat=x,const=spred,errtype=agr,orig=x,pos=adj\nvanskerlig\tvanskelig\t#errtype=nosilent,pos=adj\n",
