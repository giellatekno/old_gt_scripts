...
#crk-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:crk-lookup.cgi
#
...
# from the FORM on the Plains Cree HTML page
...
$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $crkfstdir/transcriptor-numbers2text-desc.xfst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $crkfstdir/transcriptor-numbers2text-desc.xfst` ;
