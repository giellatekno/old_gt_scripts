...
$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $mrjfstdir/transcriptor-numbers-digit2text.filtered.lookup.xfst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $mrjfstdir/transcriptor-numbers-digit2text.filtered.lookup.xfst` ;
