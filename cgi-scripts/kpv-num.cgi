...
$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $kpvfstdir/transcriptor-numbers2text-desc.xfst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $kpvfstdir/transcriptor-numbers2text-desc.xfst` ;
