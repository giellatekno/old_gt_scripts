...
#ismj-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:ismj-lookup.cgi
#
#       called from FORM on skjema.html page; output HTML
#
# Original written by Ken Beesley, Xerox, for Aymara.
# reviewed and modified 4 June 2002, Trond Trosterud
#
########################################################################

# this CGI script is called whenever a user submits a generation request
# from the FORM on the Lule Sami HTML page
...
# The directory where ismj.fst is stored
$ismjfstdir = "/opt/smi/smj/bin" ;
...
#         (which has some flags set, and which accesses ismj.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d $ismjfstdir/ismj.fst` ;
...
#               Print out a standard HTML header
    ...
    print "<HEAD>\n<TITLE>S&aacute;me morfologiia </TITLE>\n</HEAD>\n\n" ;
