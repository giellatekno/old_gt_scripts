...
#sma-lookdown.pl
#
# resides:  Web Folder:cgi-bin:smi:sma-lookdown.cgi
#
...
# The directory where isma.fst is stored
$ismafstdir = "/opt/smi/sma/bin" ;
...
#         (which has some flags set, and which accesses isma.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d $ismafstdir/isma.fst` ;
