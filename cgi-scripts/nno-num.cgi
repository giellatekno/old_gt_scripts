...
# The directory where nno-num.fst is stored
...
#         (which has some flags set, and which accesses nno-num.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $nnofstdir/nno-num.fst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $nnofstdir/nno-num.fst` ;
