...
#yrk-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:yrk-lookup.cgi
#
...
# The directory where yrk-num.fst is stored
$yrkfstdir = "/opt/smi/yrk/bin" ;
...
#         (which has some flags set, and which accesses yrk-num.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $yrkfstdir/yrk-num.fst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $yrkfstdir/yrk-num.fst` ;
