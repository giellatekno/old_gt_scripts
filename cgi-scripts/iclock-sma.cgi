...
#sma-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:sma-lookup.cgi
#
...
# The directory where iclock-sma.fst is stored
...
#         (which has some flags set, and which accesses iclock-sma.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $smafstdir/iclock-sma.fst` ;
