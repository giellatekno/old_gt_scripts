...
#rus-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:rus-lookup.cgi
#
...
#         (which has some flags set, and which accesses iclock-rus.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d  -utf8 $rusfstdir/transcriptor-clock-digit2text.filtered.lookup.xfst` ;
