...
$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $myvfstdir/transcriptor-numbers2text-desc.xfst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $myvfstdir/transcriptor-numbers2text-desc.xfst` ;
