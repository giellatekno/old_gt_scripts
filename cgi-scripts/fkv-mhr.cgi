...
#mhr-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:mhr-lookup.cgi
#
...
# The directory where mhr-num.fst is stored
$mhrfstdir = "/opt/smi/mhr/bin" ;
...
#         (which has some flags set, and which accesses mhr-num.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $mhrfstdir/mhr-num.fst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $mhrfstdir/mhr-num.fst` ;
