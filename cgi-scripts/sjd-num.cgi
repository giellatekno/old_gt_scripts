...
# The directory where sjd-num.fst is stored
...
#         (which has some flags set, and which accesses sjd-num.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $sjdfstdir/sjd-num.fst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $sjdfstdir/sjd-num.fst` ;
