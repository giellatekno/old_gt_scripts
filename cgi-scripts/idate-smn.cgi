...
#smn-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:smn-lookup.cgi
#
...
# The directory where idate-smn.fst is stored
$smnfstdir = "/opt/smi/smn/bin" ;
...
#         (which has some flags set, and which accesses idate-smn.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $smnfstdir/idate-smn.fst` ;
