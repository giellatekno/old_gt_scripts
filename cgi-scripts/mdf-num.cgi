...
# The directory where mdf-num.fst is stored
...
#         (which has some flags set, and which accesses mdf-num.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $mdffstdir/mdf-num.fst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $mdffstdir/mdf-num.fst` ;
