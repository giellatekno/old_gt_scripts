...
#rup-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:rup-lookup.cgi
#
...
$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -utf8 -d $rupfstdir/transcriptor-numbers2text-desc.xfst` ;
