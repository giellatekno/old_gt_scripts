...
#sme-lookdown.pl
#
# resides:  Web Folder:cgi-bin:smi:sme-lookdown.cgi
#
...
# The directory where isme.fst is stored
$ismefstdir = "/opt/smi/sme/bin" ;
...
#         (which has some flags set, and which accesses isme.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -utf8 -d $ismefstdir/isme.fst` ;
...
#               Print out a standard HTML header
    ...
    print "<HEAD>\n<TITLE>Davvis&aacute;megiel morfologiija </TITLE>\n</HEAD>\n\n" ;
