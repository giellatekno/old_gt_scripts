...
#hdn-lookup.pl
#
# resides:  Web Folder:cgi-bin:smi:hdn-lookup.cgi
#
...
#         (which has some flags set, and which accesses iclock-hdn.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT  -utf8 -d $hdnfstdir/transcriptor-clock-digit2text.filtered.lookup.xfst ` ;
