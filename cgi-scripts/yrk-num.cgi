...
$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -d -utf8 $yrkfstdir/transcriptor-numbers2text-desc.xfst` ;
# $utilitydir/lookup -flags mbL" => "LTT -d $yrkfstdir/transcriptor-numbers2text-desc.xfst` ;
