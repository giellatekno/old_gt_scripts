...
# The directory where sma-num.fst is stored
...
#         (which has some flags set, and which accesses sma-num.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags mbL\" => \"LTT -utf8 -d $smafstdir/sma-num.fst` ;
