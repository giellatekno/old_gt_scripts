...
# The directory where smj-num.fst is stored
...
#         (which has some flags set, and which accesses smj-num.fst)
# 3.  The output of lookup is assigned as the value of $result


$result = `echo $allwords | tr " " "\n" | \
 $utilitydir/lookup -flags L\" => \"LTT -utf8 -d $smjfstdir/smj-num.fst` ;
...
#               Print out a standard HTML header
    ...
    print "<HEAD>\n<TITLE>Julevs&aacute;megiel lohkos&aacute;nit </TITLE>\n</HEAD>\n\n" ;
