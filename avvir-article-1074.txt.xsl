...
<xsl:variable name="filename" select="'http://www.avvir.no/feed.php?news=1074&amp;output_type=txt'"/>
<xsl:variable name="title" select="'Heavvanii Iešjohkii'"/>
<xsl:variable name="author1_fn" select="'Berit Marie Lise'"/>
