...
<xsl:variable name="filename" select="'http://www.avvir.no/feed.php?news=1073&amp;output_type=txt'"/>
<xsl:variable name="title" select="'Sámi Dáiddárráđi  dilli eahpesihkar'"/>
<xsl:variable name="author1_fn" select="'Salla-Mari'"/>
<xsl:variable name="author1_ln" select="'West'"/>
...
<xsl:variable name="publChannel" select="'http://avvir.no'"/>
