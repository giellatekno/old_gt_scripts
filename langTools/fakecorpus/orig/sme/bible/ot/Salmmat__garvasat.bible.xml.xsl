...
<xsl:stylesheet version="1.0" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="filename" select="'Salmmat__garvasat_0203.doc'"/>
  <xsl:variable name="title" select="'Salmmat'"/>
  ...
  <xsl:variable name="translator_fn" select="'Britt'"/>
  <xsl:variable name="translator_ln" select="'Rajala'"/>
