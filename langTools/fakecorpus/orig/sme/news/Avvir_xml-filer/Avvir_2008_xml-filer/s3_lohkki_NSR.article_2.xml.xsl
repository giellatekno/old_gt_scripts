...
<xsl:variable name="filename" select="'s3 lohkki NSR.article 2.xml'"/>
<xsl:variable name="text_encoding" select="'UTF-8'"/>
<xsl:variable name="title" select="'Sámi aviisadoarjagatSilje Karine Muotka, NSR jođiheaddji,  Thomas Myrnes Nygård, čallingottijođiheaddji,  Norgga Sámiid Riikkasearvvi         '"/>
...
<xsl:variable name="publisher" select="'Ávvir'"/>
...
<xsl:variable name="sub_name" select="'Per Christian Biti'"/>
<xsl:variable name="sub_email" select="'per@avvir.no'"/>
