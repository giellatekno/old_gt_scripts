...
dies_ok( sub {langTools::ParatextConverter->new("fakecorpus/orig/tust.xml")}, "non-existent file");
dies_ok( sub {langTools::ParatextConverter->new("fakecorpus/avvir.xml")}, "existing file, filename doesn't contain orig in the path");
lives_ok( sub {langTools::ParatextConverter->new("fakecorpus/orig/avvir.xml")}, "existing file, filename contains orig in the path");
