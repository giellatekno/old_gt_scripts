...
alias kpvtoks="hfst-tokenise --giella-cg $GTLANGS/lang-kpv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | \
               vislcg3 -g $GTLANGS/lang-kpv/src/syntax/disambiguator.cg3 | \
               sed 's/ <W:0.0000000000>//g;'"
alias kpvtokst="hfst-tokenise --giella-cg $GTLANGS/lang-kpv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | \
               vislcg3 -g $GTLANGS/lang-kpv/src/syntax/disambiguator.cg3 -t | \
               sed 's/ <W:0.0000000000>//g;'"

alias myvtoka="hfst-tokenise --giella-cg $GTLANGS/lang-myv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | \  
               sed 's/ <W:0.0000000000>//g;'"
alias myvtoks="hfst-tokenise --giella-cg $GTLANGS/lang-myv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst |  vislcg3 -g $GTLANGS/lang-myv/src/syntax/disambiguator.cg3 | \  
               sed 's/ <W:0.0000000000>//g;'"
alias myvtokst="hfst-tokenise --giella-cg $GTLANGS/lang-myv/tools/tokenisers/tokeniser-disamb-gt-desc.pmhfst | vislcg3 -g $GTLANGS/lang-myv/src/syntax/disambiguator.cg3 -t | \  
               sed 's/ <W:0.0000000000>//g;'"
