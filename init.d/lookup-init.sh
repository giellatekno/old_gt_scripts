...
alias   dsma='$LOOKUP $GTHOME/langs/sma/src/generator.gt.xfst'
...
alias   dsmj='$LOOKUP $GTHOME/langs/smj/src/generator.gt.xfst'
...
alias   usma='$LOOKUP $GTHOME/langs/sma/src/analyser.gt.xfst'
...
alias   usmj='$LOOKUP $GTHOME/langs/smj/src/analyser.gt.xfst'
...
alias   dfao='$LOOKUP $GTHOME/langs/fao/bin/ifao.fst'
alias   diku='$LOOKUP $GTHOME/st/iku/bin/iiku.fst'
alias   dipk='$LOOKUP $GTHOME/st/ipk/bin/iipk.fst'
alias   dkal='$LOOKUP $GTHOME/langs/kal/bin/ikal.fst'
...
alias   ufao='$LOOKUP $GTHOME/langs/fao/bin/fao.fst'
...
alias dfin='$LOOKUP $GTHOME/langs/fin/src/generator.gt.xfst'
alias dizh='$LOOKUP $GTHOME/langs/izh/src/generator.gt.xfst'
alias dkca='$LOOKUP $GTHOME/langs/kca/src/generator.gt.xfst'
alias dkom='$LOOKUP $GTHOME/langs/kpv/src/generator.gt.xfst'
alias dkpv='$LOOKUP $GTHOME/langs/kpv/src/generator.gt.xfst'
alias dmdf='$LOOKUP $GTHOME/langs/mdf/src/generator.gt.xfst'
alias dmhr='$LOOKUP $GTHOME/langs/mhr/src/generator.gt.xfst'
alias dmrj='$LOOKUP $GTHOME/langs/mrj/src/generator.gt.xfst'
alias dmyv='$LOOKUP $GTHOME/langs/myv/src/generator.gt.xfst'
alias dolo='$LOOKUP $GTHOME/langs/olo/src/generator.gt.xfst'
alias dudm='$LOOKUP $GTHOME/langs/udm/src/generator.gt.xfst'
alias dvep='$LOOKUP $GTHOME/langs/vep/src/generator.gt.xfst'
alias dvro='$LOOKUP $GTHOME/kt/vro/bin/ivro.fst'
alias dyrk='$LOOKUP $GTHOME/langs/yrk/src/generator.gt.xfst'
alias uhun='$LOOKUP $GTHOME/kt/hun/bin/hun.fst'

alias ufin='$LOOKUP $GTHOME/langs/fin/src/analyser.gt.xfst'
alias uizh='$LOOKUP $GTHOME/langs/izh/src/analyser.gt.xfst'
alias ukca='$LOOKUP $GTHOME/langs/kca/src/analyser.gt.xfst'
alias ukom='$LOOKUP $GTHOME/langs/kpv/src/analyser.gt.xfst'
alias ukpv='$LOOKUP $GTHOME/langs/kpv/src/analyser.gt.xfst'
alias umdf='$LOOKUP $GTHOME/langs/mdf/src/analyser.gt.xfst'
alias umhr='$LOOKUP $GTHOME/langs/mhr/src/analyser.gt.xfst'
alias umrj='$LOOKUP $GTHOME/langs/mrj/src/analyser.gt.xfst'
alias umyv='$LOOKUP $GTHOME/langs/myv/src/analyser.gt.xfst'
alias uolo='$LOOKUP $GTHOME/langs/olo/src/analyser.gt.xfst'
alias uudm='$LOOKUP $GTHOME/langs/udm/src/analyser.gt.xfst'
...
alias умчр='$LOOKUP $GTHOME/langs/mhr/src/analyser.gt.xfst'
alias дмыв='$LOOKUP $GTHOME/langs/myv/src/generator.gt.xfst'
