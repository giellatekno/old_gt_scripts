...
alias ukom='$LOOKUP $GTHOME/langs/kom/src/analyser-gt-desc.xfst'
...
alias dkomNorm='$LOOKUP $GTHOME/langs/kom/src/generator-gt-norm.xfst'
...
alias ukomNorm='$LOOKUP $GTHOME/langs/kom/src/analyser-gt-norm.xfst'
...
alias дкомНорм='$LOOKUP $GTHOME/langs/kom/src/generator-gt-norm.xfst'
...
alias укомНорм='$LOOKUP $GTHOME/langs/kom/src/analyser-gt-norm.xfst'
...
alias hdkom='$HLOOKUP $GTHOME/langs/kom/src/generator-gt-desc.hfstol'
...
alias hdoloNorm='$HLOOKUP $GTHOME/langs/olo/src/generator-gt-norm.hfstol'
...
alias hukomNorm='$HLOOKUP $GTHOME/langs/kom/src/analyser-gt-norm.hfstol'
...
alias чуком='$HLOOKUP $GTHOME/langs/kom/src/analyser-gt-desc.hfstol'
...
alias чдком='$HLOOKUP $GTHOME/langs/kom/src/generator-gt-desc.hfstol'
...
alias чдкомНорм='$HLOOKUP $GTHOME/langs/kom/src/generator-gt-norm.hfstol'
...
alias чукомНорм='$HLOOKUP $GTHOME/langs/kom/src/analyser-gt-norm.hfstol'
...
alias хуком='$HLOOKUP $GTHOME/langs/kom/src/analyser-gt-desc.hfstol'
...
alias хдком='$HLOOKUP $GTHOME/langs/kom/src/generator-gt-desc.hfstol'
...
alias хдкомНорм='$HLOOKUP $GTHOME/langs/kom/src/generator-gt-norm.hfstol'
...
alias хукомНорм='$HLOOKUP $GTHOME/langs/kom/src/analyser-gt-norm.hfstol'
