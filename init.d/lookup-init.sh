...
alias   hdsma='$HLOOKUP $GTHOME/gt/sma/bin/isma.hfstol'
alias   hdsme='$HLOOKUP $GTHOME/gt/sme/bin/isme.hfstol'
alias   hdsmj='$HLOOKUP $GTHOME/gt/smj/bin/ismj.hfstol'
...
alias   husma='$HLOOKUP $GTHOME/gt/sma/bin/sma.hfstol'
alias   husme='$HLOOKUP $GTHOME/gt/sme/bin/sme.hfstol'
alias   husmj='$HLOOKUP $GTHOME/gt/smj/bin/smj.hfstol'
