...
process ()
{
    ...
    echo "/usr/local/bin/ccat -l $lang -r $corproot/$gt/$lang/$dir/ | $tmpdir/gt/script/preprocess --abbr=$tmpdir/gt/$lang/bin/abbr.txt --fst=$tmpdir/gt/$lang/bin/$lang.fst | lookup -flags mbTT -utf8 $tmpdir/gt/$lang/bin/$lang.fst | $tmpdir/gt/script/lookup2cg | vislcg --grammar=$tmpdir/gt/$lang/src/$lang-dis.rle  > $gadir/$lang/$dir/$dir.analyzed"
    /usr/local/bin/ccat -l $lang -r $corproot/$gt/$lang/$dir/ | $tmpdir/gt/script/preprocess --abbr=$tmpdir/gt/$lang/bin/abbr.txt --fst=$tmpdir/gt/$lang/bin/$lang.fst | lookup -flags mbTT -utf8 $tmpdir/gt/$lang/bin/$lang.fst | $tmpdir/gt/script/lookup2cg | vislcg --grammar=$tmpdir/gt/$lang/src/$lang-dis.rle  > $gadir/$lang/$dir/$dir.analyzed
